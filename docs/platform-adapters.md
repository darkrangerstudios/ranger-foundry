...
`chat.agentSkillsLocations`. Confirm the complete packaged skill roster in the Agent Customizations
...
Use `grok inspect` to confirm the resolved rules and the complete packaged native skill roster. A
